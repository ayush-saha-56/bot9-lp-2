...
const EcommerceSolution = () => {
    return (
        <section className="relative w-full md:w-[100vw] overflow-hidden bg-[#F5FAEF] py-8 md:py-[3.55vw]">
            ...
            <div className="w-full md:w-[78.33vw] mx-auto relative px-4 md:px-0">
                ...
                <div className="bg-white p-6 md:p-[3.33vw] border border-gray-200">
                    <div className="flex items-center mb-6 md:mb-[2.22vw]">
                        ...
                        <span className="text-gray-900 text-xl md:text-[1.38vw] font-medium">Employee Onboarding Assistant</span>
                    </div>
                    <div className="flex flex-col md:flex-row justify-between">
                        <div className="w-full md:w-[45%] mb-6 md:mb-0">
                            ...
                            <ul className="space-y-2 md:space-y-[1.11vw] text-[#667185] mb-6 md:mb-[3.33vw] text-base md:text-[1.38vw]">
                                <li>Sending onboarding materials</li>
                                <li>Scheduling training sessions</li>
                                <li>Managing employee documentation</li>
                                <li>Providing first-day instructions</li>
                            </ul>
