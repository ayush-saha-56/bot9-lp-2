    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className={`relative w-full max-w-[100vw] mx-auto pt-[10vw] pb-[1.94vw] px-[0.28vw] ${isMobile ? 'pt-20 pb-4 px-4' : ''}`}>
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className={`font-manrope text-[#667185] mb-[2.22vw] max-w-[350px] sm:max-w-[52.08vw] text-center ${isMobile ? 'text-md leading-normal mb-6 max-w-full' : 'text-[1.39vw] font-[400] leading-[2.08vw]'}`}>
          ...
          <div className={`w-full bg-sky-50 ${isMobile ? 'py-8' : 'mt-[10.90vw] py-[1.11vw]'} overflow-hidden`}>
            {isMobile ? (
              <div className="flex flex-col space-y-8">
                {images.map((image, index) => (
                  <div key={index} className="flex flex-col items-center">
                    ...
                    <p className="text-sm text-gray-600 text-center px-4">{image.description}</p>
                  </div>
                ))}
              </div>
            ) : (
