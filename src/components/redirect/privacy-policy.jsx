    ...
    <div className={manrope.className} style={styles.wrapper}>
      <div style={styles.container}>
        ...
        <p style={styles.paragraph}>
          At bot.ai, accessible from https://bot9.ai/, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by bot.ai and how we use it.
        </p>
        ...
        <p style={styles.paragraph}>
          ...
          shared and/or collect in bot.ai. This policy is not applicable to any
          information collected offline or via channels other than this website.
        </p>

        <h2 style={styles.heading}>Consent</h2>
        <p style={styles.paragraph}>
        ...
        >
          ...
          <li style={styles.listItem}>Send you emails</li>
          <li style={styles.listItem}>Find and prevent fraud</li>
        </ul>

        <h2 style={styles.heading}>Log files</h2>
        <p style={styles.paragraph}>
          bot.ai follows a standard procedure of using log files. These files
        ...
        <h2 style={styles.heading}>Cookies and Web Beacons</h2>
        <p style={styles.paragraph}>
          Like any other website, bot.ai uses "cookies". These cookies are used
        ...
        <p style={styles.paragraph}>
          ...
          advertisements and links that appear on bot.ai, which are sent
        ...
        <p style={styles.paragraph}>
          Note that bot.ai has no access to or control over these cookies that
          are used by third-party advertisers.
        </p>

        <h2 style={styles.heading}>Third Party Privacy Policies</h2>
        <p style={styles.paragraph}>
          bot.ai's Privacy Policy does not apply to other advertisers or
        ...
        <h2 style={styles.heading}>GDPR Data Protection Rights</h2>
        <p style={styles.paragraph}>
        ...
        <p style={styles.paragraph}>
          bot.ai does not knowingly collect any Personal Identifiable
