...
const VoiceAgentsComponent = () => {
  return (
    <section className="relative w-full md:w-[100vw] overflow-hidden bg-[#F5F5FF] border-t border-gray-300 border-dashed">
      <div className="relative w-full max-w-[100vw] mx-auto pt-16 pb-16 md:pt-[4.44vw] md:pb-[4.44vw] px-4 md:px-[0.28vw] voice-agents-container">
        ...
        <div className="hidden md:block absolute inset-0 w-full h-full pointer-events-none">
          ...
          {/* Corner element */}
          <div className="absolute w-[1.66vw] h-[1.66vw] left-[10.19vw] top-[57.63vw] z-30">
        ...
        <h1 className="font-manrope text-3xl md:text-[2.78vw] font-[500] leading-tight md:leading-[3.89vw] text-gray-900 mb-2 md:mb-[0.14vw] text-center">
          Why choose our <span className="text-[#5755FF]">Voice Agents</span>
        </h1>
        ...
        <div className="w-full md:max-w-[78.19vw] bg-white p-6 md:p-[2.22vw] border-l border-r border-gray-200 relative z-10 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-[2.22vw] relative">
            ...
            <div className="hidden md:block col-span-2 h-[3.4vw] relative">
            ...
            {/* Massive Scalability */}
            <div className="md:pb-[2.22vw] md:pl-[1.11vw]">
              <SectionTitle
                icon={
                  <Infinity
                    className="w-5 h-5 md:w-[1.11vw] md:h-[1.11vw]"
