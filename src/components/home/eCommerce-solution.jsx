...
const EcommerceSolution = () => {
    return (
        <section className="relative w-full md:w-[100vw] overflow-hidden bg-[#FFF8F0] py-8 md:py-[3.55vw]">
            ...
            <div className="w-full md:w-[78.33vw] mx-auto relative px-4 md:px-0">
                ...
                <div className="bg-white p-6 md:p-[3.33vw] border border-gray-200">
                    <div className="flex items-center mb-6 md:mb-[2.22vw]">
                        ...
                        <span className="text-gray-900 text-xl md:text-[1.38vw] font-medium">E-Commerce</span>
                    </div>
                    <div className="flex flex-col md:flex-row justify-between">
                        <div className="w-full md:w-[45%] mb-6 md:mb-0">
                            ...
                            <ul className="space-y-2 md:space-y-[1.11vw] text-[#667185] mb-6 md:mb-[3.33vw] text-base md:text-[1.38vw]">
                                ...
                                <li>Locating stores</li>
                                <li>Getting product recommendations</li>
                                <li>Managing returns</li>
                            </ul>
                            <h3 className="text-xl md:text-[1.38vw] font-semibold mb-4 md:mb-[1.11vw] text-[#101928]"></h3>
                            {/* <div className="flex space-x-4 md:space-x-[1.11vw]">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="w-12 h-12 md:w-[2.77vw] md:h-[2.77vw] bg-[#EEF4FF] rounded-md flex justify-center items-center p-0 overflow-hidden">
                                        <Image
